...
import com.labidc.gray.deploy.servlet.feign.FeignHeadTransmitAttributeObjectTransform;
import lombok.Data;
...
public class GrayDeployTransmitProerties {
     ...
     * <注意> 默认传递 String 和 基本类型    对象需要实现接口 {@link FeignHeadTransmitAttributeObjectTransform} 并 注册为bean
